/*
 * Kanaha Camera — on-device certificate provisioning (milestone B, RAPI-style).
 *
...
public class CertProvisioning {
    private static final String TAG = "KanahaCameraProvision";
    ...
    public File ensureKeypairAndCsr() throws Exception {
        ...
        File csrFile = new File(csrDir, "camera.csr");
        ...
        X500Principal subject = new X500Principal("O=Kanaha, OU=kanaha-camera, CN=" + cn);
